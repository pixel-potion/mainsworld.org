...
description: See where people can use Main's World, verify with an Orb, receive MAIN, swap it and withdraw local currency.
---
...
MAIN can be received in a compatible wallet on **World Chain**. Receiving MAIN
does not guarantee that it can be swapped or withdrawn. Never send USDC from
World Chain to a provider unless it explicitly supports USDC on World Chain.

## Sources

Availability changes. We check World's
[World App page](https://world.org/world-app),
[Orb locator](https://world.org/find-orb), and
[local withdrawal documentation](https://support.world.org/hc/en-us/articles/44413326159635-What-is-a-Virtual-Account),
plus official regulator lists:

- [Argentina CNV](https://www.argentina.gob.ar/cnv/registro-de-proveedores-de-servicios-de-activos-virtuales),
  [Brazil Central Bank](https://www.bcb.gov.br/detalhenoticia/20918/nota?s=08),
  [Chile CMF](https://www.cmfchile.cl/portal/principal/613/w3-propertyvalue-26813.html),
  [Colombia SFC](https://www.superfinanciera.gov.co/publicaciones/10115324/que-son-los-activos-digitales-o-criptoactivos/), and
  [Mexico Fintech Law](https://www.diputados.gob.mx/LeyesBiblio/pdf/LRITF.pdf).
- [EU MiCA register](https://www.esma.europa.eu/esmas-activities/digital-finance-and-innovation/markets-crypto-assets-regulation-mica),
  [UK FCA](https://www.fca.org.uk/firms/cryptoassets/who-needs-register), and
  [Canada registration search](https://info.securities-administrators.ca/nrsmobile/nrssearch.aspx).
- [Japan FSA](https://www.fsa.go.jp/en/regulated/licensed/en_kasoutuka.pdf),
  [South Korea FSC](https://www.fsc.go.kr/eng/pr010101/86533),
  [Singapore MAS](https://eservices.mas.gov.sg/fid/institution?activity=Digital+Payment+Token+Service),
  [Malaysia SC](https://www.sc.com.my/regulation/guidelines/recognizedmarkets/list-of-registered-digital-asset-exchanges),
  [Philippines BSP](https://www.bsp.gov.ph/lists/directories/attachments/19/vasp.pdf),
  [Indonesia OJK](https://ojk.go.id/en/fungsi-utama/itsk/perizinan-itsk-aset-keuangan-digital-aset-kripto/default.aspx), and
  [India FIU](https://fiuindia.gov.in/).
- [Nigeria SEC](https://www.sec.gov.ng/for-investors/sec-nigeria-clears-additional-vasps-for-accelerated-regulatory-incubation-programme/),
  [Kenya CMA](https://www.cma.or.ke/tbuilder-layout-part/regulatory-framework-regulations/),
  [Ghana SEC](https://sec.gov.gh/press-release-official-announcement-of-virtual-asset-sandbox-participants/),
  [South Africa FSCA](https://www.fsca.co.za/), and
  [Uganda FIA](https://fia.go.ug/list-of-registered-accountable-persons/).
- [Australia AUSTRAC](https://www.austrac.gov.au/virtual-asset-service-provider-register-goes-public),
  [Dubai VARA](https://www.vara.ae/en/licenses-and-register/public-register/), and
  [Peru SMV](https://www.smv.gob.pe/Uploads/COMUNICADO_Criptomoneda_ICO2021.pdf).

This page is practical availability information, not legal, tax or investment
advice. Services, fees and rules can change without notice.
