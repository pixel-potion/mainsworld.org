...
class deserves a name. We call it a **SHIP: a Secure Human Interaction
Protocol.**
...
Main's World shares users' attention with the big platforms — the social
networks, the search giants, the neighborhood apps, the events apps — but it
isn't really playing their game. Those are **attention businesses**: they make
money by keeping you looking, and they tolerate bots and fake accounts as a cost
of doing business.

A SHIP is built the other way around:
...
Next: read the **[Manifesto](/manifesto)**, or see **[how Main's World
works](/how-it-works/the-worlds)**.
